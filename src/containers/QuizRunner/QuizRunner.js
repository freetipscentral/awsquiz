...
import Header from '../../components/QuizParts/Header/Header'
  ...
  render() {
      if(!this.state.quizStarted) {
        return (<QuizNotification headerText={this.state.quizHeader} startQuiz={this.startQuiz}
          info='This quiz will test your basic knowledge of AWS.  Press Start button to start the quiz.'/>)
      } else {
      return(
        <Auxillury className={styles.flexContainer}>
          <main>
